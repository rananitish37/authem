...
export const Footer = () => {
  return (
    <footer className="bg-authem-dark text-white pt-12 pb-8 border-t border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 border-b border-slate-800">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            <div className="w-12 h-12 rounded-full bg-slate-800/80 flex items-center justify-center text-authem-green">
              <ShieldCheck className="w-6 h-6" />
            </div>
            <h4 className="font-extrabold text-base tracking-wide uppercase">100% Verified Authentic</h4>
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <h4 className="font-extrabold text-base tracking-wide uppercase">Live Market Pricing</h4>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <h4 className="font-extrabold text-base tracking-wide uppercase">Secure Transactions</h4>
            <p className="text-slate-400 text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-400 font-semibold pt-2">
              <Globe className="w-4 h-4 text-authem-green" />
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li><Link to="/browse?category=sneakers" className="hover:text-white transition-colors">Sneakers</Link></li>
              <li><Link to="/browse?category=apparel" className="hover:text-white transition-colors">Apparel</Link></li>
              <li><Link to="/browse?category=electronics" className="hover:text-white transition-colors">Electronics</Link></li>
              <li><Link to="/browse?category=collectibles" className="hover:text-white transition-colors">Collectibles</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li><Link to="/browse?brand=nike" className="hover:text-white transition-colors">Nike</Link></li>
              <li><Link to="/browse?brand=jordan" className="hover:text-white transition-colors">Air Jordan</Link></li>
              <li><Link to="/browse?brand=adidas" className="hover:text-white transition-colors">Adidas / Yeezy</Link></li>
              <li><Link to="/browse?brand=supreme" className="hover:text-white transition-colors">Supreme</Link></li>
              <li><Link to="/browse?brand=fear-of-god" className="hover:text-white transition-colors">Fear of God</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              ...
              <li><Link to="/sell" className="hover:text-white transition-colors">Sell on Authem</Link></li>
